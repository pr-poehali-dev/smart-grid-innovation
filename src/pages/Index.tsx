        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mb-24">
            ...
            <div className="space-y-6 md:space-y-8">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight text-balance">Творческая экспедиция</h2>
              <div className="space-y-4 text-white/80 leading-relaxed text-center lg:text-left">
                <p className="text-white text-lg font-semibold">
                  Уникальная возможность увидеть море, горы и древние руины глазами художника
                </p>
                <p>
                  Это не просто отдых — это <strong>8 дней в сопровождении профессионального художника</strong> с выставками в Стамбуле, Анталии и Алании. Вы не только проживёте красоту побережья, но и станете её соавтором
                </p>
                <p>
                  За время путешествия вы создадите <strong>три полноценные работы</strong>:
                </p>
                <ul className="space-y-2 text-white/80 pl-4">
                  <li>🎨 Живопись вином на закате — и дегустация, конечно</li>
                  <li>🗺️ Коллажи из навигационных карт — превращаем их в современные картины</li>
                  <li>🐚 Мозаика из ракушек, камней и морского стекла, найденных по маршруту</li>
                </ul>
                <p>
                  Все материалы уже ждут вас на борту — просто включитесь в процесс. Из путешествия вы вернётесь с тремя собственными произведениями. <strong>Такое невозможно купить в сувенирной лавке</strong> — их можно только прожить и создать
                </p>
                <p>
                  8 дней вдоль побережья: укромные бухты, Ликийская тропа, древние руины и закаты в открытом море. Капитан — профессиональный яхтенный инструктор — ведёт яхту к самым красивым точкам маршрута. А если проснётся дух пирата — покажет основы управления: штурвал, ветер в руках и ощущение курса
                </p>
                <p>
                  Старт из Фетхие на комфортабельной яхте. <strong>Небольшая группа до 6 человек</strong> — камерная атмосфера, как путешествие с друзьями, без толпы и суеты
                </p>
              </div>
            </div>
