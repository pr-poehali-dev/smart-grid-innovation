            ...
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="space-y-4 text-white/80 leading-relaxed text-center lg:text-left">
                <p className="text-white text-lg">
                  Меня зовут <strong>Инга Савина</strong> — художница, куратор выставок в Стамбуле, Анталии и Алании, и автор арт-туров
                </p>
                <p>
                  3 года веду мастер-классы и влюблена в море. Мои туры — это микс яхтинга, гор и творчества на Ликийском побережье
                </p>
                <p>
                  Я учу простым медитативным техникам: <strong>живопись вином</strong>, <strong>mix-media</strong>, <strong>мозаика из смальты</strong>. Опыт не нужен — попробуете всё в самой вдохновляющей обстановке. Из путешествия вы вернётесь с тремя собственными произведениями
                </p>
              </div>
            </div>
